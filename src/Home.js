...
export default function Home () {
    return(
        ...
        <div class="absolute inset-0 -z-10 h-full w-full bg-white bg-[linear-gradient(to_right,#f0f0f0_1px,transparent_1px),linear-gradient(to_bottom,#f0f0f0_1px,transparent_1px)] bg-[size:6rem_4rem]"></div>
            <h1 className="text-6xl font-bold pt-40">Benny Rocys</h1>
            
            <h2 className="text-3xl pt-3">  21-year-old <span className="font-semibold "> software engineer</span> from London. </h2>
            <h3 className="text-lg "> Passionate about machine learning and finance.</h3>
            ...
            <a href="https://www.linkedin.com/in/benediktas-rocys/">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="size-10">
